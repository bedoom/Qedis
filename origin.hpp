...
struct BufferSequence
{
    ...
    /**
     * An array of `iovec` structures used for scatter/gather I/O operations.
     * Each `iovec` represents a memory buffer, allowing multiple buffers
     * to be read from or written to in a single system call.
     * 
     * @note The size of the array is determined by the constant `kMaxIovec`.
     */
